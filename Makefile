...
PROJECT_FILES_L      = project/.vscode/c_cpp_properties.json $(shell find project/* -type f -not -name '*.exe' -not -name '*.reg') project/.gitignore
PROJECT_FILES_W      = project/.vscode/c_cpp_properties.json $(shell find project/* -type f -not -iname 'z64convert' -not -iname 'z64audio' -not -iname 'novl' -not -iname 'seq64_console' -not -iname 'seqas') project/.gitignore
